...
public class PatientService : IPatientService
{
        ...
        string userId)
    {
        ...
        // Invalidate cached patient count after a write.
        await _cache.RemoveAsync("patients:count");
    ...
    // Performance demo: optimized using eager loading.
    public async Task<int> GetPatientsWithNPlusOneAsync()
    {
    ...
    // Performance demo: multiple collection includes.
    public async Task<int> GetPatientsWithMultipleCollectionsAsync()
    {
        var patients = await _context.Patients
            .AsNoTracking()
            .Include(p => p.Medications)
    ...
    // Cache patient count using the cache-aside pattern.
    public async Task<int> GetPatientCountAsync()
    {
        const string cacheKey = "patients:count";
