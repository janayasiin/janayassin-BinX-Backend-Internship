...
public class PatientsController : ControllerBase
{
    ...
    [HttpGet("performance/n-plus-one")]
    public async Task<IActionResult> NPlusOneDemo()
    {
        var totalMedications =
            await _patientService.GetPatientsWithNPlusOneAsync();
    ...
    public async Task<IActionResult> GetById(int id)
    {
        ...
        var ownPatient = await _patientService.GetMyProfileAsync(
    ...
    [HttpGet("performance/multiple-collections")]
    public async Task<IActionResult> MultipleCollectionsDemo()
    {
        var totalPatients =
            await _patientService.GetPatientsWithMultipleCollectionsAsync();
    ...
    {
        var count = await _patientService.GetPatientCountAsync();
