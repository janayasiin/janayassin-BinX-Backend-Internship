...
namespace CardiacPatientMonitoringSystem.Migrations
{
    ...
    [Migration("20260909110549_AddVitalSignPatientRecordedAtIndex")]
    partial class AddVitalSignPatientRecordedAtIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CardiacPatientMonitoringSystem.Models.AppointmentNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CardiacPatientMonitoringSystem.Models.MedicalCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CardiacPatientMonitoringSystem.Models.AppointmentNote", b =>
                {
                    b.HasOne("CardiacPatientMonitoringSystem.Models.Appointment", "Appointment")
                        .WithOne("Note")
                        .HasForeignKey("CardiacPatientMonitoringSystem.Models.AppointmentNote", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CardiacPatientMonitoringSystem.Models.ApplicationUser", null)
                        .WithMany()
